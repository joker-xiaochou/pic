...
export default function NineGrid() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-indigo-100 via-purple-50 to-pink-100 p-8">
      {/* 导航栏 */}
      <nav className="bg-white bg-opacity-80 backdrop-blur-sm shadow-md fixed top-0 left-0 right-0 z-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            ...
            <div className="flex items-center">
              ...
              <Link href="/nine-grid" className="px-3 py-2 rounded-md text-sm font-medium text-indigo-700 hover:text-indigo-900 hover:bg-indigo-100 bg-indigo-100">
                九宫格
              </Link>
